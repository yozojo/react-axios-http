...
var getOption = function getOption(scope, IO) {
  ...
  var scopeArr = _lodash["default"].filter(apis, function (_ref2) {
    var key = _ref2[0];
  ...
  if (isScope && !(0, _utils.isType)(option.isScope, 'boolean')) {
                  ...
                  return _regenerator["default"].async(function _callee$(_context2) {
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        case 0:
                          _context2.next = 2;
                          return _regenerator["default"].awrap(getResult(func[fkey], params, cb, option.resultMode));
