(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('http'), require('https'), require('url'), require('stream'), require('assert'), require('tty'), require('util'), require('fs'), require('net'), require('zlib'), require('react')) :
	typeof define === 'function' && define.amd ? define(['exports', 'http', 'https', 'url', 'stream', 'assert', 'tty', 'util', 'fs', 'net', 'zlib', 'react'], factory) :
	(global = global || self, factory(global.ReactAxiosHttp = {}, global.http$1, global.https, global.url, global.stream, global.assert, global.tty, global.util, global.fs, global.net, global.zlib, global.React));
}(this, (function (exports, http$1, https, url, stream, assert, tty, util, fs, net, zlib, React) { 'use strict';
	...
	var _inBundle = false;
	var _integrity = "sha1-IlY0gZYvTWvemnbVFu8OXTwJsrg=";
	var _location = "/axios";
	...
	var _resolved = "https://r.cnpmjs.org/axios/download/axios-0.21.1.tgz";
	var _shasum = "22563481962f4d6bde9a76d516ef0e5d3c09b2b8";
	var _spec = "axios";
	var _where = "/Users/youzuqiang/Desktop/tool/react-axios-http";
	var author = {
		name: "Matt Zabriskie"
	};
	var browser$1 = {
	...
	var getXhr = function getXhr(method) {
	  return function xhr(config) {
	    ...
	    return new promise$1(function (resolve, reject) {
	      axios$1(assignConfig).then(function (res) {
	...
	var isArray$2 = _core.Array.isArray;
	...
	Http.prototype._request = function (params, handler) {
	  var chain = [xhr$1(handler), undefined];
	...
	function createInstance$1() {
	  ...
	  extend$1(instance, Http.prototype, context);
