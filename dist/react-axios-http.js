(function (global, factory) {
	 ...
	 * // => { 'a': 1, 'c': 3 }
	 */
	var assign$2 = _createAssigner(function(object, source) {
	...
	var getXhr = function getXhr(method) {
	  return function xhr(config) {
	    var assignConfig = assign_1(config, {
	      method: method.toLowerCase()
	    });
	    return new promise$1(function (resolve, reject) {
	      axios_min(assignConfig).then(function (res) {
	...
	Interceptor.prototype.forEach = function (fn) {
	  forEach_1(this.handlers, function (h) {
	    if (h !== null) {
	      fn(h);
	    }
	  });
	...
	function getAdapter(params) {
	  ...
	  adapter = hasAdapter ? adapter : xhrs[method];
	  return {
	    config: config,
	    adapter: adapter,
	...
	function xhr(handler) {
	  return /*#__PURE__*/function () {
	    var _http = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(params) {
	      var result, res;
	...
	var http = function http(apis, opt) {
	  ...
	  var _assign = assign_1(defaultOpt, opt),
	  ...
	  extend(IO, tdHttp);
	  forEach_1(apis, function (api, key) {
	    IO[key] = apiFactory(api, others, tdHttp);
	  });
	  defineProperty$3(IO, ["interceptors", "_request"]);
	  return IO;
	};
	...
	var apiFactory = function apiFactory(api, opt, tdHttp) {
	  if (isType(api, "object") && !api.url) {
	    forEach_1(api, function (obj, key) {
	...
	var defineProperty$3 = function defineProperty(target, props) {
	  if (props === void 0) {
	    props = [];
	  }

	  forEach_1(props, function (prop) {
	    defineProperty$1(target, prop, {
	      writable: true,
	      enumerable: false,
	      configurable: false
	    });
	...
	var getResult$1 = /*#__PURE__*/function () {
	  var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(func, params, handler, resultMode) {
	    return regenerator.wrap(function _callee$(_context) {
	      while (1) {
	        switch (_context.prev = _context.next) {
	          case 0:
	...
	var getScope = function getScope(arr, IO, isScope) {
	  ...
	  try {
	    var isDeep = isType(values_1(IO)[0], "object");
	    ...
	    if (isEmpty_1(arr)) return IO;
	    return reduce_1(arr, function (pre, _ref2) {
	      var _extends2;
	...
	var getOption = function getOption(scope, IO) {
	  ...
	  if (isType(scope, "object")) {
	    option = assign_1(option, scope);
	    scope = option.scope;
	  }

	  scope = isType(scope, "string") ? [scope] : scope;
	  var scopes = filter_1(apis, function (_ref3) {
	    var key = _ref3[0];
	    return includes_1(scope, key);
	  });
	  var isScope = isType(values_1(IO)[0], "object");
	...
	var connectHoc = function connectHoc(WrapperComponent, scope) {
	  ...
	  return React.forwardRef(function (props, ref) {
	    var _renderWrapper = function _renderWrapper(contextApis) {
	      ...
	      var IO = cloneDeep_1(contextApis);
	      ...
	      var connectApis = reduce_1(scopeIO, function (pre, func, key) {
	        if (isType(func, "object")) {
	          var funcObj = {};
	          forEach_1(func, function (value, key) {
	            funcObj[key] = /*#__PURE__*/function () {
	              var _ref4 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(params, cb) {
	                return regenerator.wrap(function _callee2$(_context2) {
	                  while (1) {
	                    switch (_context2.prev = _context2.next) {
	                      case 0:
	                        _context2.next = 2;
	                        return getResult$1(value, params, cb, option.resultMode);
	          ...
	          pre[key] = /*#__PURE__*/function () {
	            var _ref5 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(params, cb) {
	              return regenerator.wrap(function _callee3$(_context3) {
	                while (1) {
	                  switch (_context3.prev = _context3.next) {
	                    case 0:
	                      _context3.next = 2;
	                      return getResult$1(func, params, cb, option.resultMode);
	    ...
	    return /*#__PURE__*/React__default.createElement(Consumer, null, function (contextApis) {
